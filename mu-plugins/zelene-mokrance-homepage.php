...
.zm-home__steps>div b:after{content:"✓";position:absolute;inset:0;display:grid;place-items:center;color:#fff;font-size:1.55rem;font-weight:900;opacity:0;animation-duration:6s;animation-timing-function:linear;animation-iteration-count:infinite}
...
@keyframes zm-step-1{0%,16.9%{background:var(--accent)!important;color:#20310b;transform:scale(1.08);box-shadow:0 0 0 9px rgba(159,199,74,.22)}17%,94%{background:var(--green)!important;color:transparent;transform:scale(1)}95%,100%{background:#fff!important;color:var(--green)}}
@keyframes zm-step-2{0%,16.9%{background:#fff!important;color:var(--green)}17%,33.9%{background:var(--accent)!important;color:#20310b;transform:scale(1.08);box-shadow:0 0 0 9px rgba(159,199,74,.22)}34%,94%{background:var(--green)!important;color:transparent;transform:scale(1)}95%,100%{background:#fff!important;color:var(--green)}}
@keyframes zm-step-3{0%,33.9%{background:#fff!important;color:var(--green)}34%,50.9%{background:var(--accent)!important;color:#20310b;transform:scale(1.08);box-shadow:0 0 0 9px rgba(159,199,74,.22)}51%,94%{background:var(--green)!important;color:transparent;transform:scale(1)}95%,100%{background:#fff!important;color:var(--green)}}
@keyframes zm-step-4{0%,50.9%{background:#fff!important;color:var(--green)}51%,67.9%{background:var(--accent)!important;color:#20310b;transform:scale(1.08);box-shadow:0 0 0 9px rgba(159,199,74,.22)}68%,94%{background:var(--green)!important;color:transparent;transform:scale(1)}95%,100%{background:#fff!important;color:var(--green)}}
@keyframes zm-step-5{0%,67.9%{background:#fff!important;color:var(--green)}68%,87.9%{background:var(--accent)!important;color:#20310b;transform:scale(1.08);box-shadow:0 0 0 9px rgba(159,199,74,.22)}88%,94%{background:var(--green)!important;color:transparent;transform:scale(1)}95%,100%{background:#fff!important;color:var(--green)}}
