...
/* Homepage styling and behavior are authored in native Bricks settings. */
/*

	if ( ! is_front_page() ) return;
	wp_add_inline_style( 'zm-homepage', '.zm-home__hero-stats{background:transparent;position:absolute;z-index:2;overflow:visible}.zm-home__hero-stats:before{content:"";position:absolute;z-index:0;left:50%;bottom:0;width:100vw;height:230px;transform:translateX(-50%);background:linear-gradient(180deg,rgba(20,38,12,0),rgba(20,38,12,.84));pointer-events:none}.zm-home__hero-stats>div{position:relative;z-index:1}' );
}, 60 );
...
.zm-home__steps>div b{animation:none!important;background-image:none!important;border:1px solid var(--green)!important;background-color:#fff!important;color:var(--green)!important;transform:none}
.zm-home__steps>div.is-active b{border-width:2px!important;background-color:#eef5df!important;color:var(--green)!important;animation:zm-active-breathe 1.2s ease-in-out infinite!important;will-change:transform,box-shadow}
