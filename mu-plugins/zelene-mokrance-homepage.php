...
add_action( 'init', function () {
	if ( get_option( 'zm_homepage_version' ) === ZM_HOME_VERSION ) return;
	$page = get_post( 18048 );
	if ( ! $page || $page->post_type !== 'page' ) return;
	if ( ! get_option( 'zm_homepage_bricks_backup' ) ) {
		update_option( 'zm_homepage_bricks_backup', get_post_meta( 18048, '_bricks_page_content_2', true ), false );
	}
	$elements = array(
		array( 'id' => 'zmhsec', 'name' => 'section', 'parent' => 0, 'children' => array( 'zmhcon' ), 'settings' => array( '_padding' => array( 'top' => '0', 'right' => '0', 'bottom' => '0', 'left' => '0' ) ) ),
		array( 'id' => 'zmhcon', 'name' => 'container', 'parent' => 'zmhsec', 'children' => array( 'zmhsho' ), 'settings' => array( '_width' => '100%', '_maxWidth' => '100%' ) ),
		array( 'id' => 'zmhsho', 'name' => 'shortcode', 'parent' => 'zmhcon', 'children' => array(), 'settings' => array( 'shortcode' => '[zm_homepage]' ) ),
	);
	update_post_meta( 18048, '_bricks_page_content_2', $elements );
	update_post_meta( 18048, '_bricks_editor_mode', 'bricks' );
	update_option( 'zm_homepage_version', ZM_HOME_VERSION, false );
}, 30 );
